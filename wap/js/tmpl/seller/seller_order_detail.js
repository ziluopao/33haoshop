$(function() {
    ...
    function o() {
        var r = $(this).attr("order_id");
        location.href = WapSiteUrl + "/tmpl/seller/order_deliver_send.html?order_id=" + r 
    }
    function i(e) {
        $.ajax({
            type: "post",
    ...
    function d() {
        var r = $(this).attr("order_id");
        location.href = WapSiteUrl + "/tmpl/seller/member_evaluation.html?order_id=" + r
    }
    function a() {
        var r = $(this).attr("order_id");
        location.href = WapSiteUrl + "/tmpl/seller/member_evaluation_again.html?order_id=" + r
    }
    function n() {
        var r = $(this).attr("order_id");
        location.href = WapSiteUrl + "/tmpl/seller/refund_all.html?order_id=" + r
    }
    function l() {
        var r = $(this).attr("order_id");
    ...
    function c() {
        ...
        location.href = WapSiteUrl + "/tmpl/seller/refund.html?order_id=" + r + "&order_goods_id=" + e
    }
    function _() {
        var r = $(this).attr("order_id");
        var e = $(this).attr("order_goods_id");
        location.href = WapSiteUrl + "/tmpl/seller/return.html?order_id=" + r + "&order_goods_id=" + e
    }
});